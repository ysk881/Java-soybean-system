            ...
            <div class="row flex-column m-5">
                <div class="col">
                    <div class="card px-5">
                        ...
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/manage/upadm" method="post">
                                <div class="row ml-4">
                                    <div class="col">
                                        <!--id 用户账号 、用户权限-->
                                <%--        <div class="form-group row">
                                        ...
                                        <div class="form-group row" style="margin-left: 150px;">
                                            ...
                                            <div class="col-6">
                                                <input type="text" class="form-control" name="username" id="admname" readonly
                                        ...
                                        <div class="form-group row" style="margin-left: 150px;">
                                            ...
                                            <div class="col-6"><input type="password" class="form-control"
                                                                      name="password" id="adpass" value="${sessionScope.user.password}"/>
                                            </div>
                                        </div>
                                        <div class="form-group row" style="margin-left: 150px;">
                                            <label for="name"
