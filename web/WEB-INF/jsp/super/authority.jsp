...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/bootstrap-switch/bootstrap-switch.min.css">
    <!-- 页面样式 -->
    ...
    <script src="${pageContext.request.contextPath}/bootstrap-switch/bootstrap-switch.min.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/bootstrap/js/bootstrap.bundle.min.js"></script>

    <script type="text/javascript">
        function upall(){
            window.location.href="${pageContext.request.contextPath}/admin/excelAll";
        }
    </script>
        ...
        <div class="col overflow-auto main-box">
            ...
            <div class="row flex-column m-2">
                <div class="col">
                    <div class="card px-1">
                        <div class="card-header bg-white text-cinerous">
									<span class="h5 font-weight-bold">权限管理
										<i class="bi bi-caret-right"></i>
										<small>全部用户权限管理</small>
										<i class="bi bi-forward"></i>
										<small>可以通过搜索相应的账号或者相应用户名对其信息进行修改、删除等管理操作。★</small>
									</span>
                        </div>
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/admin/authority" method="post">
                                <div class="row ml-2">
                                    <div class="col">
                ...
                <div class="col mt-2">
                    <div class="card px-3">
                        <div class="card-body">
                            <%--<form action="${pageContext.request.contextPath}/admin/delectAuthority" method="post">--%>
                                <div>
                                    <a href="${pageContext.request.contextPath}/admin/toAddUser"
                                       class="btn btn-success" data-toggle="modal"
                                       data-target="#addUserModel"><i class="bi bi-person-fill-add"></i>添加用户</a>
                                    <button type="button" class="btn btn-danger" onclick="deleteAuthAll()"><i class="bi bi-trash-fill"></i>批量删除</button>
                                    <a type="button" class="btn btn-success" onclick="upall()">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table small text-muted table-bordered mt-3">
                                        <tr>
                                            <th class="col-p-3"><input type="checkbox" id="allauth"
                                                                       onclick="allauthClick()"></th>
                                            <th class="col-p-3">账号</th>
                                            <th class="col-p-5">用户名称</th>
                                            <th class="col-p-5">账号权限</th>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        <button type="button" class="btn btn-warning btn-sm"
                                                                ...
                                                                data-toggle="modal"
                                                                data-target="#updateAuthModal">修改</button>&nbsp;&nbsp;
                                                        <button type="button" class="btn btn-danger btn-sm"
                                                                data-usid="${user.usid}"
                                                                data-username="${user.username}"
                                                                data-toggle="modal"
                                                                data-target="#delAuthModal">
                            ...
                            <!-- 添加模态框 Model -->
                            <form method="post"
                                  class="form-horizontal" action="${pageContext.request.contextPath}/admin/addAuthority" >
                                <div class="modal fade" id="addUserModel" tabindex="-1" aria-labelledby="AddUsers"
                                     aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="AddUsers">添加用户信息</h5>
                            ...
                            <!-- 修改模态框 Model -->
                            <form method="post"
                                  class="form-horizontal" action="${pageContext.request.contextPath}/admin/updateauthority" >
                                <div class="modal fade" id="updateAuthModal" tabindex="-1" aria-labelledby="UPdateAuth"
                                     aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="UPdateAuth">修改权限信息</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            ...
                                            <div class="modal-body ">
                                                <input type="hidden" name="usid" id="ausid" value="">
                                                <div class="form-group row ">
                                                    <label for="auusername"
                                                           class="col-3 col-form-label">用户账号：</label>
                                                    <div class="col-7"><input type="text" class="form-control"
                                                                              id="ausername" name="username"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="mt-2">
                                                        <input type="radio" checked class="permission"  name="permission" id="permission"
                                                               value="用户"/>用户
                                                        <input type="radio" class="permission" name="permission" id="permission"
                                                               value="普通管理员"/>普通管理员
                                                            </div>
                                                    </div>
                                                </div>
                            ...
                            <!-- 删除模态框示例（Modal） -->
                            <form method="post" action="${pageContext.request.contextPath}/admin/delectAuthById"
                                  class="form-horizontal">
                                <div class="modal fade" id="delAuthModal" tabindex="-1"
                                                ...
                                                <form class="form-horizontal" role="form">
                                                    <div class="form-group">
                                                        <div class="col-sm-9">
                                                            ...
                                                            <input
                                                                    type="hidden" class="form-control" id="auusid"
                                                                    name="usid"  placeholder="">
                                                            <input
                                                                    type="hidden" class="form-control" id="auusername"
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-end m-0">
                                        <li <c:if test="${pageInfo.isFirstPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/admin/authority?pn=1"
                                        ...
                                        <li <c:if test="${!pageInfo.hasPreviousPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/admin/authority?pn=${pageInfo.prePage==0?1:pageInfo.prePage}"
                                        ...
                                        <c:forEach begin="0" items="${pageInfo.navigatepageNums}"
                                            ...
                                            <c:if test="${pageNum != pageInfo.pageNum }">
                                                <li class="page-item"><a
                                                        href="${pageContext.request.contextPath}/admin/authority?pn=${pageNum}"
                                                        class="page-link">${pageNum}</a></li>
                                            </c:if>
                                        </c:forEach>
                                        <%--跳到下一页 判断是否有下一页 则不可点击后跳 class="disabled" --%>
                                        <li <c:if test="${!pageInfo.hasNextPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/admin/authority?pn=${pageInfo.nextPage==pageInfo.pages?pageInfo.pages:pageInfo.nextPage}"
                                               class="page-link">下一页</a>
                                        </li>
                                        <li <c:if test="${pageInfo.isLastPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/admin/authority?pn=${pageInfo.pages}"
...
<script type="text/javascript">
    ...
    $('#updateAuthModal').on('show.bs.modal', function(event) {
        ...
        modal.find('.modal-title').text('修改权限信息')
        modal.find('#ausid').val(usid)
        modal.find('#ausername').val(username)
        modal.find('#aname').val(name)
        var list =  modal.find('.permission')
        for(var i=0;i<list.length;i++){
            if(permission === $(list.get(i)).val()){
                $(list.get(i)).prop('checked',true)
            }
        }
    });

    $('#delAuthModal').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget)
        var usid = button.data('usid')
        var username = button.data('username')
        var modal = $(this)
        ...
        modal.find('#auusid').val(usid)
        modal.find('#auusername').val(username)

    });
</script>
<script type="text/javascript">
    function deleteAuthAll() {
        ...
        $.ajax({
            type:"post",
            url:"${pageContext.request.contextPath}/admin/delectAuth",
