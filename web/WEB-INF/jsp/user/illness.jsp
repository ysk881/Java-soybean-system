            ...
            <div class="col-md-12 column">
                <div class="row flex-column m-3 bg-light">
                    <div class="col">
                        <div class="card-body">
                            <div class="sour">
                                <form action="${pageContext.request.contextPath}/User/allNess" class="form-inline">
                                    <input type="text" class="col-8 form-control mb-8 mr-sm-8" id="" name="illness"
                                           placeholder="请输入抗病毒性....">
                    ...
                    <div class="col">
                        <div class="card-body">
                            <div class="row clearfix">
                                <div class="col-md-12 column">
                                    <div class="row">
                                        <c:forEach var="ness" items="${pageInfo.list}" varStatus="pages">
                                            <div class="col-md-3 bg-white border border-info rounded">
                                                <h3 class="text-info text-center">
                                                    ${ness.name}
                                                </h3>
                                                <div class="thumbnail m-2">
                                                    <img alt="300x200" src="${pageContext.request.contextPath}/image/${ness.image}"
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end m-0">
                                <li <c:if test="${pageInfo.isFirstPage}">class="page-item disabled"</c:if>>
                                    <a href="${pageContext.request.contextPath}/User/allNess?pn=1"
                                ...
                                <li <c:if test="${!pageInfo.hasPreviousPage}">class="page-item disabled"</c:if>>
                                    <a href="${pageContext.request.contextPath}/User/allNess?pn=${pageInfo.prePage==0?1:pageInfo.prePage}"
                                ...
                                <c:forEach begin="0" items="${pageInfo.navigatepageNums}"
                                    ...
                                    <c:if test="${pageNum != pageInfo.pageNum }">
                                        <li class="page-item"><a
                                                href="${pageContext.request.contextPath}/User/allNess?pn=${pageNum}"
                                                class="page-link">${pageNum}</a></li>
                                    </c:if>
                                </c:forEach>
                                <%--跳到下一页 判断是否有下一页 则不可点击后跳 class="disabled" --%>
                                <li <c:if test="${!pageInfo.hasNextPage}">class="page-item disabled"</c:if>>
                                    <a href="${pageContext.request.contextPath}/User/allNess?pn=${pageInfo.nextPage==pageInfo.pages?pageInfo.pages:pageInfo.nextPage}"
                                       class="page-link">下一页</a>
                                </li>
                                <li <c:if test="${pageInfo.isLastPage}">class="page-item disabled"</c:if>>
                                    <a href="${pageContext.request.contextPath}/User/allNess?pn=${pageInfo.pages}"
