                                ...
                                <div class="row">
                                    <div class="col-md-12 column">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/User/allVar">种质资源</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">基本信息</li>
                                                <li class="breadcrumb-item active" aria-current="page">品种详情</li>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-4 float-right ">
                                            <img class="img-rounded"
                                                 style="width: 360px;height: 330px; margin-left: 40px;"
                                                 src="${pageContext.request.contextPath}/image/${va.image}" id="vimg">
                                        </div>
                                        <div class="col-8 row">
                                            ...
                                            <table class="table table-hover table-striped">
                                                <tr>
                                                    <th>产量（kg/hm2）</th>
                                                    <td>${va.yield}<span>kg/hm2</span></td>
                                                    <th>播种月份</th>
                                                    <td>${va.month}</td>
                                                </tr>
                                                <tr>
                                                    <th>播量/kg</th>
                                                    <td>${va.rate}<span>kg</span></td>
                                                    <th>保苗/万株/hm²</th>
                                                    <td>${va.protect}<span>（万株）</span></td>
                                                </tr>
                                                <tr>
                                                    <th>适宜区域</th>
                                                    <td colspan="4">${va.area}</td>
                                                </tr>
                                                <tr>
                                                    <th>品种来源</th>
                                                    <td colspan="4">${va.source}</td>
                                                </tr>
                                                <tr>
                                                    <th>抗病性</th>
                                                    <td colspan="4">${va.illness}</td>
                                                </tr>
                                ...
                                <div class="row m-2">
                                    <div class="col-md-12 column">
                                        ...
                                        <table class="table table-hover table-striped">
                                            <tr>
                                                <th>花色</th>
                                                <td>${va.phytology.flower}<span>色</span></td>
                                                <th>叶形状</th>
                                                <td>${va.phytology.leaf}<span>叶</span></td>
                                                <th>种子形状</th>
                                                <td>${va.phytology.seed}<span>形</span></td>
                                            </tr>
                                            <tr>
                                                <th>种皮颜色</th>
                                                <td>${va.phytology.testa}</td>
                                                <th>种脐颜色</th>
                                                <td>${va.phytology.hilum}<span>色</span></td>
                                                <th>茸毛色</th>
                                                <td>${va.phytology.fuzz}<span>色</span></td>
                                            </tr>
                                            <tr>
                                                <th>子叶色</th>
                                                <td>${va.phytology.contyledon}<span>色</span></td>
                                ...
                                <div class="row m-2">
                                    <div class="col-md-12 column">
                                        ...
                                        <table class="table table-hover table-striped">
                                            <tr>
                                                <th>株高/cm</th>
                                                <td>${va.biology.height}<span>cm</span></td>
                                                <th>主茎节数</th>
                                                <td>${va.biology.pedicle}</td>
                                                <th>主茎荚数</th>
                                                <td>${va.biology.pod}</td>
                                                <th>分枝数</th>
                                                <td>${va.biology.branch}</td>
                                            </tr>
                                            <tr>
                                                <th>倒伏性</th>
                                                <td>${va.biology.lodging}</td>
                                                <th>地上部生物量/t/hm2</th>
                                                <td>${va.biology.biomass}</td>
                                                <th>生育日数/d</th>
                                                <td>${va.biology.fertility} <span>天</span></td>
                                                <th>习性</th>
                                                <td>${va.biology.habit}</td>
                                            </tr>
                                            <tr>
                                                <th>初花期/d</th>
                                                <td>${va.biology.anthesis} <span>天</span></td>
                                                <th>生育后期/d</th>
                                                <td>${va.biology.afterbirth} <span>天</span></td>
                                                <th>全生育期/d</th>
                                                <td>${va.biology.lifetime} <span>天</span></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="row m-2">
                                    <div class="col-md-12 column">
                                        ...
                                        <table class="table table-hover table-striped">
                                            <tr>
                                                <th>百粒重/g</th>
                                                <td>${va.quality.grain}<span>g</span></td>
                                                <th>油脂含量/%</th>
                                                <td>${va.quality.grease}<span>%</span></td>
                                                <th>脂肪含量/%</th>
                                                <td>${va.quality.fat}<span>%</span></td>
                                                <th>蛋白质含量/%</th>
                                                <td>${va.quality.protein}<span>%</span></td>
                                            </tr>
                                            <tr>
                                                <th>蛋脂含量/%</th>
                                                <td>${va.quality.lipid}<span>%</span></td>
                                                <th>耐盐性指数</th>
                                                <td>${va.quality.salt}</td>
                                                <th>耐碱性指数</th>
                                                <td>${va.quality.alkali}</td>
                                                <th>胱氨酸</th>
                                                <td>${va.quality.cystine}</td>
                                            </tr>
                                            <tr>
                                                <th>蛋氨酸</th>
                                                <td>${va.quality.methionine}</td>
                                                <th>硬脂酸</th>
                                                <td>${va.quality.hard}</td>
                                                <th>软脂酸</th>
                                                <td>${va.quality.soft}</td>
                                                <th>油酸</th>
                                                <td>${va.quality.oil}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
