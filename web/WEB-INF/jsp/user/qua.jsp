                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="${pageContext.request.contextPath}/User/allVar">种质资源</a></li>
                            <li class="breadcrumb-item active">农艺性状</li>
                            <li class="breadcrumb-item active" aria-current="page">品质性状</li>
                        </ol>
                    </nav>
                </div>
                <div class="card-body">
                    <form role="form" class="form-inline" action="${pageContext.request.contextPath}/User/allqua"
                          method="post">
                        ...
                        <div class=" form-group" style="margin-left: 50px">
                            <label>百粒重：</label>
                            <input type="text" class=" form-control" name="grain" placeholder="请输入粒子重量...."
                                   maxlength="12" style="width: 280px">
                        </div>
                        <div class=" form-group" style="margin-left: 50px">
                            <label>油脂含量：</label>
                            <input type="text" class=" form-control" name="grease" placeholder="请输入油脂含量...."
                                   maxlength="12" style="width: 280px">
                        </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-link btn-sm"
                                               href="${pageContext.request.contextPath}/User/selByQua?name=${qua.name}">查看详情</a>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-end m-0">
                            <li <c:if test="${pageInfo.isFirstPage}">class="page-item disabled"</c:if>>
                                <a href="${pageContext.request.contextPath}/User/allqua?pn=1"
                            ...
                            <li <c:if test="${!pageInfo.hasPreviousPage}">class="page-item disabled"</c:if>>
                                <a href="${pageContext.request.contextPath}/User/allqua?pn=${pageInfo.prePage==0?1:pageInfo.prePage}"
                            ...
                            <c:forEach begin="0" items="${pageInfo.navigatepageNums}"
                                ...
                                <c:if test="${pageNum != pageInfo.pageNum }">
                                    <li class="page-item"><a
                                            href="${pageContext.request.contextPath}/User/allqua?pn=${pageNum}"
                                            class="page-link">${pageNum}</a></li>
                                </c:if>
                            </c:forEach>
                            <%--跳到下一页 判断是否有下一页 则不可点击后跳 class="disabled" --%>
                            <li <c:if test="${!pageInfo.hasNextPage}">class="page-item disabled"</c:if>>
                                <a href="${pageContext.request.contextPath}/User/allqua?pn=${pageInfo.nextPage==pageInfo.pages?pageInfo.pages:pageInfo.nextPage}"
                                   class="page-link">下一页</a>
                            </li>
                            <li <c:if test="${pageInfo.isLastPage}">class="page-item disabled"</c:if>>
                                <a href="${pageContext.request.contextPath}/User/allqua?pn=${pageInfo.pages}"
