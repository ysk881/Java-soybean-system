...
<div class="konwbody">
    <div class="container">
                ...
                <div class="col">
                    <div class="card px-1">
                        <div class="card-header bg-white text-cinerous">
                            ...
                            <span>~<i class="bi bi-caret-right"></i>豆类科普~~</span>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                <tbody>
                                <c:forEach var="kno" items="${knowList}" varStatus="pages">
                                    <tr>
                                        <td><img class="image" src="${pageContext.request.contextPath}/image/${kno.knimg}" alt=""></td>
                                        <td><span class="h4">${kno.knname}</span>&nbsp; &nbsp;<span
                                                class="text-capitalize font-weight-bold">(${kno.knspell})</span>
                                            <p class="text-justify">
                                                    ${kno.kninfo}
                                            </p>
                                            <p class="text-sm-right"><a href="${pageContext.request.contextPath}/User/selByKnowId?knid=${kno.knid}">查看详情&nbsp;<i
        ...
        <div class="row col-md-12 flex-column m-2 bg-dark">
            <div class="m-3">
