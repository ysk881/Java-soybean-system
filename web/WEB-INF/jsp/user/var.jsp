                    ...
                    <div class="col">
                        <div class="card-body">
                            <div class="row clearfix">
                                <div class="col-md-12 column">
                                    <div class="row">
                                        <c:forEach var="va" items="${pageInfo.list}" varStatus="pages">
                                            <div class="col-md-3 border border-secondary">
                                                <div class="thumbnail">
                                                    <img alt="300x200"
                                                         src="${pageContext.request.contextPath}/image/${va.image}"
                                                         class="m-2"
                                                    ...
                                                    <div class="caption m-2">
                                                        ...
                                                        <p>
															<span
                                                                    class="font-weight-bolder">产&nbsp;量(kg/hm2):</span>&nbsp;<small>${va.yield}<span>(kg/hm2)</span></small>
                                                        </p>
                                                        <p>
															<span
                                                                    class="font-weight-bolder">播种月份:</span>&nbsp;<small>${va.month}</small>
                                                        </p>
                                                        <p>
                                                            <span class="font-weight-bolder">播量/kg：</span><small>${va.rate}
                                                            <span>kg</span></small>
                                                        </p>
                                                        <p>
                                                            <a class="btn btn-info"
                                                               href="${pageContext.request.contextPath}/User/selectById?id=${va.id}">查看详情</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end m-0">
                                <li <c:if test="${pageInfo.isFirstPage}">class="page-item disabled"</c:if>>
                                    <a href="${pageContext.request.contextPath}/User/allVar?pn=1"
                                ...
                                <li <c:if test="${!pageInfo.hasPreviousPage}">class="page-item disabled"</c:if>>
                                    <a href="${pageContext.request.contextPath}/User/allVar?pn=${pageInfo.prePage==0?1:pageInfo.prePage}"
                                ...
                                <c:forEach begin="0" items="${pageInfo.navigatepageNums}"
                                    ...
                                    <c:if test="${pageNum != pageInfo.pageNum }">
                                        <li class="page-item"><a
                                                href="${pageContext.request.contextPath}/User/allVar?pn=${pageNum}"
                                                class="page-link">${pageNum}</a></li>
                                    </c:if>
                                </c:forEach>
                                <%--跳到下一页 判断是否有下一页 则不可点击后跳 class="disabled" --%>
                                <li <c:if test="${!pageInfo.hasNextPage}">class="page-item disabled"</c:if>>
                                    <a href="${pageContext.request.contextPath}/User/allVar?pn=${pageInfo.nextPage==pageInfo.pages?pageInfo.pages:pageInfo.nextPage}"
                                       class="page-link">下一页</a>
                                </li>
                                <li <c:if test="${pageInfo.isLastPage}">class="page-item disabled"</c:if>>
                                    <a href="${pageContext.request.contextPath}/User/allVar?pn=${pageInfo.pages}"
