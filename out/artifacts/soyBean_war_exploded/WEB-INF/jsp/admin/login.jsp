        ...
        <form action="${pageContext.request.contextPath}/admin/login" method="post">
            ...
            <div class="modal-body" id="model-body">
                <div class="form-group" align="center">
                    <h4 class="modal-title text-center text-muted">大豆种质资源管理员登录</h4>
                </div>
                <div class="form-group" align="center">
                ...
                <div class="form-group" align="center">
                    <label class="radio-inline">
                        <input type="radio" name="type"  value="Admin" class="radio-inline"> 超级管理员
                    </label> &nbsp; &nbsp;
                    <label class="radio-inline">
                        <input type="radio" name="type" checked value="User" class="radio-inline" > 普通管理员
                    </label>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <div class="form-group">
                    <button type="button" class="btn btn-link"><a href="${pageContext.request.contextPath}/User/tologin">普通用户登录</a></button>
                </div>
            </div>
        </form>
