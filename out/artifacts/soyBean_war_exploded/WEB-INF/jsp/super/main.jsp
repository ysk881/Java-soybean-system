...
<head>
    ...
    <script type="text/javascript">
        function fileChange() {
            ...
            $.ajaxFileUpload({
                url: '${pageContext.request.contextPath}/variety/ajaxImg',//用于文件上传的服务器端请求地址
    ...
    <script type="text/javascript">
        function d() {
            window.location.href = "${pageContext.request.contextPath}/variety/excel";
        }
    </script>
    <script type="text/javascript">
        $(document).ready(function () {
            $("#soyname").blur(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "${pageContext.request.contextPath}/variety/findname",
                    data: "name=" + na,
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="${pageContext.request.contextPath}/admin/outlogin" class="dropdown-item">
                                    <span style="margin-left: 35px;">退出&nbsp;&nbsp;&nbsp;<i
            ...
            <div class="row flex-column m-2">
                <div class="col">
                    <div class="card px-1">
                        ...
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/variety/allVarietys" method="post">
                                <div class="row ml-2">
                                    <div class="col">
                ...
                <div class="col mt-2 ">
                    <div class="card px-3 ">
                        <div class="card-body">
                            ...
                            <div>
                                <a href="${pageContext.request.contextPath}/variety/toAddVarietys"
                                   class="btn btn-success" data-toggle="modal"
                                   data-target="#addModel">新增品种基础信息</a>
                                ...
                                <table class="table small text-muted table-bordered mt-3">
                                    ...
                                    <c:forEach var="var" items="${pageInfo.list}" varStatus="pages">
                                        <tr>
                                            ...
                                            <td class="truncate" style="padding-top: 35px">${var.area}</td>
                                            <td class="truncate" style="padding-top: 35px">${var.source}</td>
                            ...
                            <!-- 添加模态框 Model -->
                            <form action="${pageContext.request.contextPath}/variety/saves" method="post"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body ">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div id="imageDiv" class="img-thumbnail"
                            ...
                            <!-- 修改模态框 Model -->
                            <form action="${pageContext.request.contextPath}/variety/updateVar"
                            ...
                            <!-- 修改模态框 Model -->
                            <form action="${pageContext.request.contextPath}/variety/updateImg"
                                  class="form-horizontal" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" class="form-control" disabled="disabled"
                                                                   id="imaname" style="border: none;background-color:transparent;"
                                                                   />
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 column ">
                                                    ...
                                                    <table class="table table-hover table-striped">
                                                        ...
                                                        <tr>
                                                            <th>适宜区域</th>
                                                            <td colspan="4"><input type="text" disabled="disabled" class="form-control"
                                                                                   id="varea"
                                                                                   value=""
                                                                                   style="border: none;background-color:transparent;"/>
                                                            </td>
                            ...
                            <!-- 删除模态框示例（Modal） -->
                            <form method="post" action="${pageContext.request.contextPath}/variety/delectVarId"
                                  class="form-horizontal">
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-end m-0">
                                        <li <c:if test="${pageInfo.isFirstPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/variety/allVarietys?pn=1"
                                        ...
                                        <li <c:if test="${!pageInfo.hasPreviousPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/variety/allVarietys?pn=${pageInfo.prePage==0?1:pageInfo.prePage}"
                                        ...
                                        <c:forEach begin="0" items="${pageInfo.navigatepageNums}"
                                            ...
                                            <c:if test="${pageNum != pageInfo.pageNum }">
                                                <li class="page-item"><a
                                                        href="${pageContext.request.contextPath}/variety/allVarietys?pn=${pageNum}"
                                                        class="page-link">${pageNum}</a></li>
                                            </c:if>
                                        </c:forEach>
                                        <%--跳到下一页 判断是否有下一页 则不可点击后跳 class="disabled" --%>
                                        <li <c:if test="${!pageInfo.hasNextPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/variety/allVarietys?pn=${pageInfo.nextPage==pageInfo.pages?pageInfo.pages:pageInfo.nextPage}"
                                               class="page-link">下一页</a>
                                        </li>
                                        <li <c:if test="${pageInfo.isLastPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/variety/allVarietys?pn=${pageInfo.pages}"
...
<script type="text/javascript">
    function deleteVarAll() {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/variety/deleteVar",
