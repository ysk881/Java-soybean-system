            ...
            <div class="row flex-column m-2">
                <div class="col">
                    <div class="card px-1">
                        ...
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/know/allknows" method="post">
                                <div class="row ml-2">
                                    <div class="col">
                ...
                <div class="col mt-2 ">
                    <div class="card px-3 ">
                        <div class="card-body">
                            ...
                            <div>
                                <a href="${pageContext.request.contextPath}/know/toAddKnow"
                            ...
                            <!-- 添加模态框 Model -->
                            <form action="${pageContext.request.contextPath}/know/addKnow" method="post"
                            ...
                            <!-- 删除模态框示例（Modal） -->
                            <form method="post" action="${pageContext.request.contextPath}/know/delknow"
                                  class="form-horizontal">
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-end m-0">
                                        <li <c:if test="${pageInfo.isFirstPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/know/allknows?pn=1"
                                        ...
                                        <li <c:if test="${!pageInfo.hasPreviousPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/know/allknows?pn=${pageInfo.prePage==0?1:pageInfo.prePage}"
                                        ...
                                        <c:forEach begin="0" items="${pageInfo.navigatepageNums}"
                                            ...
                                            <c:if test="${pageNum != pageInfo.pageNum }">
                                                <li class="page-item"><a
                                                        href="${pageContext.request.contextPath}/know/allknows?pn=${pageNum}"
                                                        class="page-link">${pageNum}</a></li>
                                            </c:if>
                                        </c:forEach>
                                        <%--跳到下一页 判断是否有下一页 则不可点击后跳 class="disabled" --%>
                                        <li <c:if test="${!pageInfo.hasNextPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/know/allknows?pn=${pageInfo.nextPage==pageInfo.pages?pageInfo.pages:pageInfo.nextPage}"
                                               class="page-link">下一页</a>
                                        </li>
                                        <li <c:if test="${pageInfo.isLastPage}">class="page-item disabled"</c:if>>
                                            <a href="${pageContext.request.contextPath}/know/allknows?pn=${pageInfo.pages}"
...
<script type="text/javascript">
    function deleteKNAll() {
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/know/delknows",
