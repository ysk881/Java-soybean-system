                ...
                <div class="card-header bg-white text-cinerous">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">植物学特征</li>
                        </ol>
                    </nav>
                </div>
                <div class="card-body">
                    <form role="form" class="form-inline" action="${pageContext.request.contextPath}/User/allphy" method="post">
                        <div class="form-group">
                            <label >品种名称：</label>
                            <input type="text" class=" form-control" name="name" placeholder="请输入关键字...."
                                   maxlength="20" style="width: 280px">
                        </div>
                        <div class=" form-group" style="margin-left: 50px">
                            <label >花色：</label>
                            <input type="text" class=" form-control" name="flower" placeholder="请输入想要查询的花色...."
                                   maxlength="12" style="width: 280px">
                        </div>
                        <div class=" form-group" style="margin-left: 50px">
                            <label >叶形状：</label>
                            <input type="text" class=" form-control" name="leaf" placeholder="请输入想要查询的子叶形状...."
                                   maxlength="12" style="width: 280px">
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-link btn-sm" href="${pageContext.request.contextPath}/User/selByName?name=${phy.name}">查看详情</a>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-end m-0">
                            <li <c:if test="${pageInfo.isFirstPage}">class="page-item disabled"</c:if>>
                                <a href="${pageContext.request.contextPath}/User/allphy?pn=1"
                            ...
                            <li <c:if test="${!pageInfo.hasPreviousPage}">class="page-item disabled"</c:if>>
                                <a href="${pageContext.request.contextPath}/User/allphy?pn=${pageInfo.prePage==0?1:pageInfo.prePage}"
                            ...
                            <c:forEach begin="0" items="${pageInfo.navigatepageNums}"
                                ...
                                <c:if test="${pageNum != pageInfo.pageNum }">
                                    <li class="page-item"><a
                                            href="${pageContext.request.contextPath}/User/allphy?pn=${pageNum}"
                                            class="page-link">${pageNum}</a></li>
                                </c:if>
                            </c:forEach>
                            <%--跳到下一页 判断是否有下一页 则不可点击后跳 class="disabled" --%>
                            <li <c:if test="${!pageInfo.hasNextPage}">class="page-item disabled"</c:if>>
                                <a href="${pageContext.request.contextPath}/User/allphy?pn=${pageInfo.nextPage==pageInfo.pages?pageInfo.pages:pageInfo.nextPage}"
                                   class="page-link">下一页</a>
                            </li>
                            <li <c:if test="${pageInfo.isLastPage}">class="page-item disabled"</c:if>>
                                <a href="${pageContext.request.contextPath}/User/allphy?pn=${pageInfo.pages}"
