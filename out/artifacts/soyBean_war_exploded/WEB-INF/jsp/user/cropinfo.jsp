                        ...
                        <div class="card px-1">
                            <div class="card-header bg-white text-cinerous">
                                ...
                                <span class="h5 font-weight-bold"><a href="${pageContext.request.contextPath}/User/allknow"
											...
											<small><a href="${pageContext.request.contextPath}/User/allcrop"
                                                      class="text-decoration-none">农作物科普</a></small>
										</span>
                            </div>
                            <div class="card-body">
                                <div class="row col-md-12 column">
                                    <div class="col-md-6">
                                        <div class="text-center">
                                            ...
                                            <p></p>
                                            <span
                                                    class="font-weight-bold">学名</span>&nbsp;:&nbsp;<span>${cr.knspell}</span>
                                            <p></p>
                                            <span
                                                    class="font-weight-bold">别名</span>&nbsp;:&nbsp;<span>${cr.knalias}</span>
                                        </div>

                                    </div>
                                    <div class="col-md-6 ">
                                        <img src="${pageContext.request.contextPath}/image/${cr.knimg}"
